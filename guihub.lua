...
Maru = {
	...
	AcrylicMain = Color3.fromRGB(15, 20, 25),
	AcrylicBorder = Color3.fromRGB(30, 50, 70),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 15, 20), Color3.fromRGB(10, 15, 20)),
	AcrylicNoise = 0.95,
	TitleBarLine = Color3.fromRGB(25, 40, 55),
	Tab = Color3.fromRGB(40, 65, 90),
	Element = Color3.fromRGB(40, 65, 90),
	ElementBorder = Color3.fromRGB(5, 10, 15),
	InElementBorder = Color3.fromRGB(35, 55, 75),
	ElementTransparency = 0.9,
	ToggleSlider = Color3.fromRGB(40, 65, 90),
	ToggleToggled = Color3.fromRGB(0, 60, 100),
	SliderRail = Color3.fromRGB(40, 65, 90),
	DropdownFrame = Color3.fromRGB(60, 85, 110),
	DropdownHolder = Color3.fromRGB(20, 30, 40),
	DropdownBorder = Color3.fromRGB(5, 10, 15),
	DropdownOption = Color3.fromRGB(40, 65, 90),
	Keybind = Color3.fromRGB(40, 65, 90),
	Input = Color3.fromRGB(60, 85, 110),
	InputFocused = Color3.fromRGB(80, 105, 130),
	InputIndicator = Color3.fromRGB(50, 75, 100),
	Dialog = Color3.fromRGB(20, 30, 40),
	DialogHolder = Color3.fromRGB(15, 25, 35),
	DialogHolderLine = Color3.fromRGB(10, 20, 30),
	DialogButton = Color3.fromRGB(25, 40, 55),
	DialogButtonBorder = Color3.fromRGB(45, 70, 95),
	DialogBorder = Color3.fromRGB(40, 65, 90),
	DialogInput = Color3.fromRGB(30, 50, 70),
	DialogInputLine = Color3.fromRGB(70, 95, 120),
...
Yaru = {
	Name = "Yaru",
	Accent = Color3.fromRGB(119, 178, 85),
	...
	ToggleToggled = Color3.fromRGB(119, 178, 85),
	...
	DialogBorder = Color3.fromRGB(170, 170, 170),
...
Vynixu = {
	...
	ToggleToggled = Color3.fromRGB(255, 85, 85),
	SliderRail = Color3.fromRGB(100, 100, 100),
	DropdownFrame = Color3.fromRGB(130, 130, 130),
    ...
    GithubDark = {
		...
		AcrylicMain = Color3.fromRGB(22, 27, 34),
		AcrylicBorder = Color3.fromRGB(48, 54, 61),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(13, 17, 23)),
		TitleBarLine = Color3.fromRGB(48, 54, 61),
		Tab = Color3.fromRGB(48, 54, 61),
		Element = Color3.fromRGB(48, 54, 61),
		ElementBorder = Color3.fromRGB(33, 38, 45),
		InElementBorder = Color3.fromRGB(48, 54, 61),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromRGB(48, 54, 61),
		ToggleToggled = Color3.fromRGB(31, 111, 235),
		SliderRail = Color3.fromRGB(48, 54, 61),
		DropdownFrame = Color3.fromRGB(33, 38, 45),
		DropdownHolder = Color3.fromRGB(22, 27, 34),
		DropdownBorder = Color3.fromRGB(48, 54, 61),
		DropdownOption = Color3.fromRGB(48, 54, 61),
		Keybind = Color3.fromRGB(48, 54, 61),
		Input = Color3.fromRGB(33, 38, 45),
		InputFocused = Color3.fromRGB(22, 27, 34),
		InputIndicator = Color3.fromRGB(139, 148, 158),
		Dialog = Color3.fromRGB(33, 38, 45),
		DialogHolder = Color3.fromRGB(22, 27, 34),
		DialogHolderLine = Color3.fromRGB(48, 54, 61),
		DialogButton = Color3.fromRGB(33, 38, 45),
		DialogButtonBorder = Color3.fromRGB(48, 54, 61),
		DialogBorder = Color3.fromRGB(48, 54, 61),
		DialogInput = Color3.fromRGB(22, 27, 34),
		DialogInputLine = Color3.fromRGB(139, 148, 158),
...
Abyss = {
	...
	AcrylicBorder = Color3.fromRGB(30, 45, 70),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 10, 20), Color3.fromRGB(5, 10, 20)),
	AcrylicNoise = 0.92,
	TitleBarLine = Color3.fromRGB(25, 40, 60),
	Tab = Color3.fromRGB(40, 65, 100),
	Element = Color3.fromRGB(40, 65, 100),
	ElementBorder = Color3.fromRGB(5, 10, 20),
	InElementBorder = Color3.fromRGB(35, 55, 85),
	ElementTransparency = 0.89,
	ToggleSlider = Color3.fromRGB(40, 65, 100),
	ToggleToggled = Color3.fromRGB(15, 25, 40),
	SliderRail = Color3.fromRGB(40, 65, 100),
	DropdownFrame = Color3.fromRGB(60, 95, 140),
	DropdownHolder = Color3.fromRGB(20, 30, 50),
	DropdownBorder = Color3.fromRGB(5, 10, 20),
	DropdownOption = Color3.fromRGB(40, 65, 100),
	Keybind = Color3.fromRGB(40, 65, 100),
	Input = Color3.fromRGB(60, 95, 140),
	InputFocused = Color3.fromRGB(80, 120, 180),
	InputIndicator = Color3.fromRGB(50, 80, 120),
	Dialog = Color3.fromRGB(20, 30, 50),
	DialogHolder = Color3.fromRGB(15, 25, 40),
	DialogHolderLine = Color3.fromRGB(10, 20, 35),
	DialogButton = Color3.fromRGB(25, 40, 65),
	DialogButtonBorder = Color3.fromRGB(45, 70, 110),
	DialogBorder = Color3.fromRGB(40, 65, 100),
	DialogInput = Color3.fromRGB(30, 50, 80),
	DialogInputLine = Color3.fromRGB(70, 110, 160),
	Text = Color3.fromRGB(220, 230, 240),
	SubText = Color3.fromRGB(150, 170, 190),
	Hover = Color3.fromRGB(50, 80, 120),
	HoverChange = 0.08,
},
	Yellow = {
		Name = "Yellow",
		Accent = Color3.fromRGB(255, 230, 0),
		AcrylicBorder = Color3.fromRGB(255, 255, 150),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 255, 80), Color3.fromRGB(255, 255, 80)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(255, 255, 120),
		Tab = Color3.fromRGB(255, 255, 140),
		Element = Color3.fromRGB(255, 255, 140),
		ElementBorder = Color3.fromRGB(255, 255, 80),
		InElementBorder = Color3.fromRGB(255, 255, 160),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(255, 255, 140),
		ToggleToggled = Color3.fromRGB(255, 255, 60),
		SliderRail = Color3.fromRGB(255, 255, 140),
		DropdownFrame = Color3.fromRGB(255, 255, 180),
		DropdownHolder = Color3.fromRGB(255, 255, 100),
		DropdownBorder = Color3.fromRGB(255, 255, 80),
		DropdownOption = Color3.fromRGB(255, 255, 140),
		Keybind = Color3.fromRGB(255, 255, 140),
		Input = Color3.fromRGB(255, 255, 180),
		InputFocused = Color3.fromRGB(255, 255, 220),
		InputIndicator = Color3.fromRGB(255, 255, 160),
		Dialog = Color3.fromRGB(255, 255, 100),
		DialogHolder = Color3.fromRGB(255, 255, 90),
		DialogHolderLine = Color3.fromRGB(255, 255, 70),
		DialogButton = Color3.fromRGB(255, 255, 100),
		DialogButtonBorder = Color3.fromRGB(255, 255, 140),
		DialogBorder = Color3.fromRGB(255, 255, 130),
		DialogInput = Color3.fromRGB(255, 255, 110),
		DialogInputLine = Color3.fromRGB(255, 255, 180),
		Text = Color3.fromRGB(30, 30, 30),
		SubText = Color3.fromRGB(80, 80, 80),
		Hover = Color3.fromRGB(255, 255, 160),
		HoverChange = 0.07,
    },
	Darker = {
		Name = "Darker",
